...
Example: `A6_problem_landscape_permitting_coordination.md`
...
```json
{
  "id": "A6_problem_landscape_permitting_coordination",
  "section": "A",
  "title": "Problem Landscape: Permitting Coordination Gaps",
...
```json
{
  "id": "research/A6_problem_landscape_permitting_coordination",
  "path": "research/A6_problem_landscape_permitting_coordination.md",
  "type": "research_report",
  "title": "Problem Landscape: Permitting Coordination Gaps",
  "pillar": "thriving-built-environment",
  "section": "A",
  "summary": "One to two sentence grounded summary.",
  "tags": ["permitting", "coordination", "DPW"],
  "recommended_audience": ["teams exploring project visibility", "teams researching DPW friction"],
  "read_after": ["research/A1_problem_landscape_infrastructure_visibility.md"],
...
`evidence_log.md` (root level) tracks verified factual claims.
