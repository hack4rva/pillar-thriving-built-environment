...
The underlying feature layer for the Capital Project Dashboard is not explicitly published outside the dashboard view, and the Roads geometry consists of polygons rather than centerlines [4]. However, maintenance datasets are available to supplement this, including Street Sweeping areas on the Open Data Portal [10] and Priority 1 Snow Routes covering 700 lane miles [11].
 ...
 * Street Sweeping areas and Priority 1 Snow Routes (700 lane miles) are available via the Open Data Portal and RVA.gov [10] [11].
...
9. *City of Chicago :: Supporting Info Rollup*. https://www.chicago.gov/city/en/depts/streets/provdrs/street/supp_info.html
10. *Street Sweeping | Open Data Portal | City of Richmond, Virginia*. https://data.richmondgov.com/d/2dh8-bzzs
11. *Snow Removal | Richmond*. https://www.rva.gov/public-works/snow-removal