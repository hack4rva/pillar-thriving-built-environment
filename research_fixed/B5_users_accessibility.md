...
* **Legal Mandate ≠ Practical Visibility:** 100% of Work-in-Street Permits must include an ADA-compliant pedestrian plan under DPW Administrative Directive 10.8 and Ordinance No. 2019-314 [1] [2]. Hackathon tools should auto-pull permit data daily and flag any location where an approved detour is missing from public maps.
